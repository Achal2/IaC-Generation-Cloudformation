...
def lambda_handler(event, context):
    ...
    try:
        ...
        print('iac-gen lambda')
        # GitHub information
        repo_owner = 'Dheeraj-Peopletech'
        repo_name = 'IAC-CDK'
        token = os.environ['GITHUB_TOKEN']
        account_email = 'dheeraj.makineedi@peopletech.com'
        commit_message = 'Initial Cloudformation code'

        #Knowledge base ID
        kb_id = os.environ['KNOWLEDGE_BASE_ID']

        # Define the directory path and file names
        main_tf_path = f'Cloudformation/main.yaml'
